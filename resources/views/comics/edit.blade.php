...
@section('content')
    ...
    <form method="POST" action="{{ route('comic.update', $comic->id) }}">
        ...
        <input type="text" name="description" id="description" value="{{ old('description', $comic['description']) }}">
        ...
        <input type="number" step=".01" name="price" id="price" value="{{ old('price', $comic['price']) }}">
